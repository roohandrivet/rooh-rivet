...
export const metadata: Metadata = {
  title:
    "Terms & Conditions",
  description:
    "Terms and conditions information for Rooh & Rivet.",
  alternates: {
    canonical:
      "https://www.roohandrivet.com/terms",
  },
};
          ...
          <div className="px-6 py-10 sm:px-10 sm:py-14">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 text-amber-900">
              <p className="font-semibold">
                Terms and conditions have not yet been published.
              </p>

              <p className="mt-2 text-sm leading-6">
                This temporary page prevents broken links while the approved
                legal wording is being prepared. It is not a substitute for
            ...
            <div className="mt-10 space-y-6 text-[#6F5B55]">
              <p className="leading-8">
                Rooh &amp; Rivet will publish its approved terms here before
                final production launch. The completed terms should cover
                ordering, payment, pricing, shipping, cancellations, returns,
                refunds, product availability, intellectual property and
                limitations of liability.
              </p>

              <p className="leading-8">
                Until the approved terms are available, please avoid relying on
                this page as a complete agreement governing purchases.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-[#7A6464]">
                    ...
                    about orders, payments, shipping or returns.
                  </p>
